...
if(isset($_POST['savethisshit'])){
    ...
    $sql = "INSERT INTO tbl_inventory_system(Sampleconn, pas_type, pas_partNum, pas_compartnum,pas_partName,pas_RevLvl,pas_supplier,pas_unitprice,pas_carmodel,pas_clrsticker,pas_standardstock,pas_safetystock,pas_RegCode,pas_location,pas_remarks,pas_harness_code) VALUES 
                                            ('$Sampleconn','$pas_type','$pas_partNum', '$pas_compartnum','$pas_partName','$pas_RevLvl','$pas_supplier','$pas_unitprice','$pas_carmodel','$pas_clrsticker','$pas_standardstock','$pas_safetystock','$pas_RegCode','$pas_location','$pas_remarks','$pas_harness_code')";
