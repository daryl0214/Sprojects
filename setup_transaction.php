			...
			<div class="card-body1">
				...
				<div class="row">
						<div class="col-sm-12 table-responsive">
							...
							<a type="button"href=" setups.php" class="btn btn-primary bg-gradient rounded-0 btn-sm"><i class="far fa-plus-square"></i>SETUP ACCESSORIES</a>
								<thead><tr>
                                        ...
                                        {                                           
                                            ...
                                            {    
                                                ...
                                                <tr>
													...
													<a type="button" class="btn btn-danger" href ="setup_process.php?id=<?= $row['ID'] ?>"  id= "addBrand"> OUT</a>
                                                    </form>
